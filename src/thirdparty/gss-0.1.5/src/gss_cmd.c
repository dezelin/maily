/*
  ...
  gengetopt --no-handle-help --no-handle-version --input gss.ggo --file-name gss_cmd 
...
const char *gengetopt_args_info_purpose = "Command line interface to GSS, used to explain error codes.";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVm:q", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'm':	/* Describe a `major status' error code vaue in plain text..  */
